...
public class MyFloatView implements OnCompletionListener, OnErrorListener,OnInfoListener, OnPreparedListener, OnSeekCompleteListener,OnVideoSizeChangedListener, SurfaceHolder.Callback,android.view.View.OnClickListener
{
	...
	public final static String LOGCAT = "andli";
	...
	private void initialUI()
	{
		...
		int i = 0;
//		String filePath = Environment.getExternalStorageState()+"/test.mp4";
		String filePath = Environment.getExternalStorageState()+"/front_vedio.3gp";
	...
	public void onPrepared(MediaPlayer mp)
	{
		...
		FrameLayout.LayoutParams sParams = new FrameLayout.LayoutParams(android.widget.FrameLayout.LayoutParams.WRAP_CONTENT,android.widget.FrameLayout.LayoutParams.WRAP_CONTENT);
	...
	public static final int left = -VIEW_WIDTH / 2, top = 0, right = WIDTH- VIEW_WIDTH / 2, bottom = HEIGHT - VIEW_HEIGHT / 2;
